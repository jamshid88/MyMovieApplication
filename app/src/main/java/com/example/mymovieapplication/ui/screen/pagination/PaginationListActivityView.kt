...
import ru.surfstudio.android.easyadapter.sample.ui.screen.common.controllers.MovieItemController
...
class PaginationListActivityView : BaseRenderableActivityView<PaginationListScreenModel>() {
    ...
    private val controller = MovieItemController { toast(it.toString()) }
